...
file_list = list.files('../../trip/cl20180102_TRIP_K562_evsr/cDNA', pattern='normalized',
                       full.names=T)
...
ggplot(data[data$LAD=='LAD', ], aes(x=log10(border_dist + 1), y=expression, color=class)) +
    geom_point(size=0.5) +
    theme_bw() +
...
ggplot(data[data$LAD=='LAD', ], aes(x=log10(nearest_Pradeepa + 1), y=expression, color=class)) +
    geom_point(size=0.5) +
    theme_bw() +
    scale_color_manual(values=COL_class) +
    xlim(0,7) +
...
ggplot(data[data$LAD=='LAD', ], aes(x=log10(nearest_schmidl + 1), y=expression, color=class)) +
    geom_point(size=0.5) +
    theme_bw() +
    scale_color_manual(values=COL_class) +
...
ggplot(data[data$LAD=='LAD', ], aes(x=log10(nearest_H3K4me1 + 1), y=expression, color=class)) +
    geom_point(size=0.5) +
    theme_bw() +
    scale_color_manual(values=COL_class) +
...
ggplot(data[data$LAD=='LAD', ], aes(x=log10(nearest_H3K4me3 + 1), y=expression, color=class)) +
    geom_point(size=0.5) +
    theme_bw() +
    scale_color_manual(values=COL_class) +
...
ggplot(data[data$LAD=='LAD', ], aes(x=log10(nearest_H3K9ac + 1), y=expression, color=class)) +
    geom_point(size=0.5) +
    theme_bw() +
    scale_color_manual(values=COL_class) +
...
ggplot(data[data$LAD=='LAD', ], aes(x=log10(nearest_ATAC + 1), y=expression, color=class)) +
    geom_point(size=0.5) +
    theme_bw() +
    scale_color_manual(values=COL_class) +
    ggtitle('ATAC-seq') +
...
ggplot(data[data$LAD=='LAD', ], aes(x=log10(nearest_peak + 1), y=expression, color=class)) +
    geom_point(size=0.5) +
    theme_bw() +
    scale_color_manual(values=COL_class) +
    xlim(0,7) +
...
all_lad_gr = all_gr[which(all_gr$LAD=='AD')]
